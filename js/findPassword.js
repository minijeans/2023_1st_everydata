...
//     const academic_numberIsEmpty = checkField('academic_number', '학번을 입력해주세요.');

//     //아이디, 이름, 학번이 모두 비어있지 않을 경우 비밀번호 찾기 시도
//     if (!idIsEmpty && !nameIsEmpty && !academic_numberIsEmpty){
//         const id = $('#id').val();
//         const name = $('#name').val();
//         const academic_number = $('#academic_number').val();
